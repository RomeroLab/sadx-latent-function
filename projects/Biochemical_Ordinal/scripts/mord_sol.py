...
EDIT by Sameer: This is a copy of the threshold based ordinal regression from
https://github.com/fabianp/mord/blob/master/mord/threshold_based.py

It has been edited lightly to save the solver in the model. This allows it to
get the inverse Hessian and hence the variance covariance matrix. 
...
class LogisticAT(base.BaseEstimator):
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        self.coef_, self.theta_, self.sol = threshold_fit(
